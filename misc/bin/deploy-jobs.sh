#!/usr/bin/env bash
# Deploy this project buidl as a GCP cloud run job and it's related schedule.
#
# This will deploy each of the jobs and related schedules for all defined in
# CLOUD_RUN_JOBS
#
CLOUD_RUN_JOBS="clinvar-rcv-ftp-watcher clinvar-vcv-ftp-watcher clinvar-vcv-ftp-watcher-new"
...
deploy() { 
	...
	echo "Creating new Cloud Run Job: ${instance}"
	command="create"
    fi
    ...
    echo "Deployment of ${instance} complete."
}
